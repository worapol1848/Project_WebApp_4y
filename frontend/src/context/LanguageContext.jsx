...
export const translations = {
  ...
  th: {
    ...
    // Admin Orders - by worapol สุดหล่อ
    adm_manage_orders: 'จัดการคำสั่งซื้อลูกค้า',
    ...
    adm_all_orders: 'ออเดอร์',
    adm_pending_check: 'รอตรวจสอบ',
    adm_verified_only: 'ตรวจสอบแล้วเท่านั้น',
    adm_shipping_status: 'สถานะการจัดส่ง',
    adm_all_status: 'ทุกสถานะ',
    adm_order_id: 'รหัสออเดอร์',
    adm_customer: 'ลูกค้า',
    adm_date: 'วันที่',
    adm_total: 'ยอดรวม',
    adm_slip_check: 'ตรวจสลิป',
    adm_actions: 'จัดการ',
    adm_no_orders_found: 'ไม่พบคำสั่งซื้อที่ตรงกับตัวกรองของคุณ',
    ...
    adm_monthly_performance_log: 'บันทึกสรุปผลงานรายวันประจำเดือน',
    adm_revenue_contribution: 'สัดส่วนรายได้',
    adm_units_sold_items: 'จำนวนที่ขายได้',
    adm_daily_sales_cal: 'ปฏิทินยอดขายรายวัน',
    adm_revenue_summary_desc: 'ข้อมูลสรุปนี้แสดงถึงผลการดำเนินงานสะสมในทุกรอบธุรกิจ ใช้แผนภูมิด้านบนเพื่อระบุแนวโน้มการเติบโตและเดือนที่มีผลงานสูงสุด',
    adm_page_label: 'หน้า:',
    adm_page: 'หน้า',
    adm_of: 'จาก',
    adm_logs_loading: 'กำลังโหลดบันทึก...',
    adm_logs_title: 'บันทึกความเคลื่อนไหวระบบ',
    adm_logs_desc: 'ตรวจจับและบันทึกทุกการเคลื่อนไหวของแอดมิน ทั้งการจัดการสินค้า อัปเดตสต็อก และระบบออเดอร์ทั้งหมด',
    adm_logs_th_datetime: 'วันเวลา',
    adm_logs_th_admin: 'แอดมิน',
    adm_logs_th_action: 'การกระทำ',
    adm_logs_th_target: 'เป้าหมาย',
    adm_logs_th_entity: 'ไอดีอ้างอิง',
    adm_logs_th_details: 'รายละเอียด',
    adm_logs_no_activity: 'ไม่พบประวัติความเคลื่อนไหว',
